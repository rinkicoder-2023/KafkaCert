 ...
 */
package com.crazycoder.kafka.avro;
...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3712554782953030874L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"com.crazycoder.kafka.avro\",\"fields\":[{\"name\":\"customerName\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static com.crazycoder.kafka.avro.Order.Builder newBuilder() {
    return new com.crazycoder.kafka.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.crazycoder.kafka.avro.Order.Builder newBuilder(com.crazycoder.kafka.avro.Order.Builder other) {
    if (other == null) {
      return new com.crazycoder.kafka.avro.Order.Builder();
    } else {
      return new com.crazycoder.kafka.avro.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.crazycoder.kafka.avro.Order.Builder newBuilder(com.crazycoder.kafka.avro.Order other) {
    if (other == null) {
      return new com.crazycoder.kafka.avro.Order.Builder();
    } else {
      return new com.crazycoder.kafka.avro.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.crazycoder.kafka.avro.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.crazycoder.kafka.avro.Order other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.customerName)) {
        this.customerName = data().deepCopy(fields()[0].schema(), other.customerName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.crazycoder.kafka.avro.Order.Builder setCustomerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.crazycoder.kafka.avro.Order.Builder clearCustomerName() {
      customerName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.crazycoder.kafka.avro.Order.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.crazycoder.kafka.avro.Order.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.crazycoder.kafka.avro.Order.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.crazycoder.kafka.avro.Order.Builder clearQuantity() {
